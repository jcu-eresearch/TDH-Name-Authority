#
# Rules file for software Services data
#
import time
...
class IndexData:
    ...
    def __newDoc(self):
        ...
        self.utils.add(self.index, "display_type", "services")
    ...
    def __metadata(self):
        ...
        self.utils.add(self.index, "dc_identifier", identifier)
        ...
        self.utils.add(self.index, "dc_subject", data.get("ANZSRC_FOR_1"))
        self.utils.add(self.index, "dc_subject", data.get("ANZSRC_FOR_2"))
        self.utils.add(self.index, "dc_subject", data.get("ANZSRC_FOR_3"))
        self.utils.add(self.index, "dc_description", data.get("brief_description"))
