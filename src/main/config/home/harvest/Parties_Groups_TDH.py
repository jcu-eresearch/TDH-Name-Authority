...
#        for key in data.keySet():x
#            self.utils.add(self.index, key, data.get(key))
        self.utils.add(self.index, "ID", data.get("ID"))
        self.utils.add(self.index, "Name", data.get("Name"))
        self.utils.add(self.index, "Email", data.get("Email"))
        self.utils.add(self.index, "Phone", data.get("Phone"))
        self.utils.add(self.index, "Parent_Group_ID", data.get("Parent_Group_ID"))
        self.utils.add(self.index, "URI", data.get("URI"))
        self.utils.add(self.index, "NLA_Party_Identifier", data.get("NLA_Party_Identifier"))
        self.utils.add(self.index, "Homepage", data.get("Homepage"))
        self.utils.add(self.index, "Description", data.get("Description"))
        self.utils.add(self.index, "Active_From", data.get("Active_From"))
        self.utils.add(self.index, "Active_To", data.get("Active_To"))

        #Old_ID, do we care about it, how should it be indexed? Jay think about it.
